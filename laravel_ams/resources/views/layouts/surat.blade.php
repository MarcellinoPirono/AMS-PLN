    ...
    <main>
        ...
        @foreach ($po_khs as $pokhs)
            ...
            <div style="margin-top: 20px">
                ...
                @if (count($lokasis) == 1)
                    <ol type="none"
                        style="margin-top:20px; margin-left: 40px; margin-right: 10px; font-weight:bold; text-align:justify;">
                        @foreach ($lokasis as $lokasi)
                ...
                @else
                    <ol type="1"
                        style="margin-top:20px; margin-left: 55px; margin-right: 10px; font-weight:bold; text-align:justify;">
                        @foreach ($lokasis as $lokasi)
            ...
            <div class="content3" style="margin-left: 40px; margin-right: -5px;">
                ...
                <div style="margin-left:23px; justify-content: space-between;">
                    <p style="left:40px; justify-content: space-between;">
            ...
            <table width="85%" border="0" cellspacing="0" cellpadding="0" align="center" nobr="true"
                ...
                <tr nobr="true">
                    ...
                    <td class="tabellkanan1" colspan="2" style="text-align:justify"> Apabila SPBJ/PO ini saudara(i)
                ...
                <tr>
                    ...
                    <td style="width:43%;" align="center" valign="bottom">PT PLN (PERSERO) UIW SULSELRABAR</td>
                </tr>
                <tr>
                ...
                <tr style="height: 86px;">
                    <td style="height: 86px;" align="center" valign="bottom">
    ...
    <div class="wrapword" id="firstTable">
        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr style="page-break-before: avoid">
                ...
                <td class="first10" colspan="4" style="width:36%;" align="center" valign="bottom">Makassar,
            ...
            <tr style="page-break-before: avoid">
                ...
                <td class="noborder" colspan="4" align="center" valign="middle">{{ $pokhs->pejabats->jabatan }}
                </td>
            </tr>
            <tr style="height: 85px; page-break-before: avoid">
                <td class="noborder" colspan="2" style="height: 85px;" align="center" valign="bottom">
                    <b>{{ $nama_manager }}</b>
                </td>
