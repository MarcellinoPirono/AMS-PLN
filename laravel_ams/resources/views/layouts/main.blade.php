...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/') }}./asset/frontend/images/favicon.png" />
    <link rel="stylesheet" href="{{ asset('/') }}./asset/frontend/vendor/chartist/css/chartist.min.css" />`
    <link href="{{ asset('/') }}./asset/frontend/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet" />
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('/') }}./asset/frontend/images/logo.png" alt="" />
                <img class="logo-compact" src="{{ asset('/') }}./asset/frontend/images/logo-text.png" alt="" />
                <img class="brand-title" src="{{ asset('/') }}./asset/frontend/images/logo-text.png" alt="" />
            </a>
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('/') }}./asset/frontend/images/avatar/1.jpg" class="rounded-circle user_img" alt="" />
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('/') }}./asset/frontend/images/avatar/2.jpg" class="rounded-circle user_img" alt="" />
                                ...
                                <div class="card">
                                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                                        ...
                                        <div class="dropdown mt-sm-0 mt-3">
                                            <button type="button" class="btn rounded btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Weekly</button>
                                            <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="col-xl-12">
                                <div class="card featuredMenu">
                                    ...
                                    <div class="card-footer style-1 text-center border-0 pt-0 pb-4">
                                        <a class="text-primary dz-load-more fa fa-chevron-down" id="FeaturedMenus" href="javascript:void(0);" rel="ajax/featured-menu-list.html"> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
