        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="logo-compact" src="{{ asset('/') }}./asset/frontend/images/logo-text.png"
                    alt="" />
                <img class="brand-title" src="{{ asset('/') }}./asset/frontend/images/logo-text.png"
                    alt="" />
            </a>
                            ...
                            <div class="card-header d-sm-flex d-block pb-0 border-0">
                                ...
                                <div class="dropdown mb-3 show">
                                    <button type="button" class="btn rounded btn-light" data-toggle="dropdown"
                                        ...
                                        Running
                                        <svg class="ml-2" width="14" height="8" viewBox="0 0 14 8"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="card">
                                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                                        ...
                                        <a href="food-menu.html"
                                            class="btn btn-primary rounded d-none d-md-block">View More</a>
                                    </div>
                                    ...
                                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                                        ...
                                        <div class="dropdown mt-sm-0 mt-3">
                                            <button type="button" class="btn rounded btn-primary dropdown-toggle"
                                                data-toggle="dropdown" aria-expanded="false">Weekly</button>
                                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="card featuredMenu">
                                    ...
                                    <div class="card-body loadmore-content height750 dz-scroll pt-0"
                                        ...
                                        <div class="media mb-4">
                                            <img src="images/menus/1.png" width="85" alt=""
                                                class="rounded mr-3" />
                                            <div class="media-body">
                                        ...
                                        <div class="media mb-4">
                                            <img src="images/menus/2.png" width="85" alt=""
                                                class="rounded mr-3" />
                                            <div class="media-body">
                                        ...
                                        <div class="media mb-4">
                                            <img src="images/menus/3.png" width="85" alt=""
                                                class="rounded mr-3" />
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen
                                                        (No Sugar Added) Fruits</a></h5>
                                        ...
                                        <div class="media mb-4">
                                            <img src="images/menus/4.png" width="85" alt=""
                                                class="rounded mr-3" />
                                            <div class="media-body">
                                    ...
                                    <div class="card-footer style-1 text-center border-0 pt-0 pb-4">
                                        <a class="text-primary dz-load-more fa fa-chevron-down" id="FeaturedMenus"
                                            href="javascript:void(0);" rel="ajax/featured-menu-list.html"> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
