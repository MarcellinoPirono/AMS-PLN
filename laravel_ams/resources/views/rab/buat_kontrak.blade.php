            ...
            <a href="/khs/create">
                <div class="card avtivity-card">
                    <div class="card-body text-center ai-icon  text-primary">
                        ...
                        <a href="/khs/create" class="btn my-2 btn-secondary btn-lg px-4"> Buat Sekarang <i
            ...
            <a href="/create-via-laksdan">
                <div class="card avtivity-card">
                    <div class="card-body text-center ai-icon  text-primary">
                        ...
                        <a href="javascript:void(0);" class="btn my-2 btn-secondary btn-lg px-4"> Buat Sekarang <i
                                class="fa fa-arrow-right" aria-hidden="true"></i></a>
                    </div>
                    <div class="effect bg-primary"></div>
                </div>
            ...
            <a href="/create-non-po">
                ...
                <div class="card avtivity-card">
                    <div class="card-body text-center ai-icon  text-primary">
                        ...
                        <a href="javascript:void(0);" class="btn my-2 btn-secondary btn-lg">Buat Sekarang <i
                                class="fa fa-arrow-right" aria-hidden="true"></i> </a>
                    </div>
                    <div class="effect bg-primary"></div>
                </div>
