...
@section('content')
    ...
    <script>
        ...
        function onSubmitData() {
            ...
            var nama_lokasi = [];
            for (var i = 0; i < clicklokasi; i++) {
                nama_lokasi[i] = document.getElementById("lokasi[" + (i + 1) + "]").value;
            }
            ...
            for (var i = 0; i < clickredaksi; i++) {
                redaksi_id[i] = document.getElementById("redaksi_id[" + (i + 1) + "]").value;
                deskripsi_id[i] = document.getElementById("deskripsi_id[" + (i + 1) + "]").value;
                sub_deskripsi_id[i] = document.getElementById("sub_deskripsi_id[" + (i + 1) + "]").value;
