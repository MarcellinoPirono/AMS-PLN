...
class RedaksiNotaDinasSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        RedaksiNotaDinas::create([
            'nama_redaksi' => 'Realisasi atau permintaan addendum',
        ...
        RedaksiNotaDinas::create([
            'nama_redaksi' => 'Kordinasi ULP, K3 & Jadwal Padam',
