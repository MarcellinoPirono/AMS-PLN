...
// alert(clickpaket)
    ...
    select2.innerHTML = "<option value='' selected disabled>Pilih Paket Pekerjaan</option>";
    ...
    select3.innerHTML = "<option value='' selected disabled>Pilih Klasifikasi</option>";
