...
@section('content')
                ...
                <div class="m-auto" style="width:97%;">
                    ...
                    <div id="informasi_umum" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                        <form id="edit_valid_redaksi" class="row row-cols-1 ms-5 me-5 needs-validation" novalidate>
                            ...
                            <div class="row m-auto">
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="old_nama_redaksi" value="{{ $redaksis->nama_redaksi }}">
                                        <input type="text" class="form-control" id="nama_redaksi" name="nama_redaksi"
                                            value="{{ old('nama_redaksi', $redaksis->nama_redaksi) }}"
                                            placeholder="Nama Redaksi" required autofocus>
                                ...
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="deskripsi_redaksi" id="deskripsi_redaksi"
                                            placeholder="Deskripsi Redaksi" required autofocus value="{{ old('deskripsi_redaksi') }}">{{ $redaksis->deskripsi_redaksi }}</textarea>
                                        {{-- <div class="valid-feedback">
                                        Data Terisi
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <table class="table table-responsive-sm height-100" width="100%" id="tabelSPBJ">
                                ...
                                @foreach ($sub_deskripsis as $sub_deskripsi)
                                    @if ($sub_deskripsi->sub_deskripsi !== null)
                                        <tr>
                                            ...
                                            <td>
                                                <textarea type="text" class="form-control lokasi" id="sub_deskripsi_id[{{ $loop->iteration }}]"
                                                    name="sub_deskripsi_id[{{ $loop->iteration }}]" placeholder="Sub Deskripsi" required>{{ $sub_deskripsi->sub_deskripsi }}</textarea>
                                            </td>
            ...
            $('#edit_valid_redaksi').validate({
                ...
                submitHandler: function(form) {
                    ...
                    for (var i = 0; i < clicksubdeskripsi; i++) {
                        sub_deskripsi[i] = [document.getElementById('sub_deskripsi_id[' + (i + 1) + ']')
                            .value
                        ];
                    }
    ...
    <script>
        ...
        $(document).ready(function() {
            var old_nama_redaksi = document.getElementById('old_nama_redaksi').value;
            $('#edit_valid_redaksi').validate({
                rules: {
                    nama_redaksi: {
                        required: true,
