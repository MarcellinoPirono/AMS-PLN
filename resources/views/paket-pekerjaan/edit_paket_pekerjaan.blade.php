                            ...
                            <div class="col-lg-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-default" id="nama_paket" name="nama_paket"
                                        value="{{$nama_paket}}" placeholder="Nama Paket" required autofocus>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="custom-control custom-checkbox checkbox check-lg mr-3">
                                                    <input data-tagname={{ $loop->iteration }} type="checkbox" class="custom-control-input" id="checkBox2[{{$loop->iteration}}]" name="letter" value="" required autofocus onclick="check(this)">
